  ...
  return (
    <div className="grid place-items-center py-5 px-8">
      ...
      <div className="leading-[140%] text-center tracking-[0.015em]">
        <Text className="font-medium text-3xl my-6">Please enter code</Text>
        <Text className="font-normal text-base text-[#B3B3B3] my-6">
      ...
      <div className="text-center">
        ...
        <div className="grid grid-cols-6 gap-3.5 max-w-md">
          {verifyId.map(() => (
            <div className=" rounded-md border-[0.8px] md:h-16 h-12 md:w-16 w-12  border-solid border-[#ABA6A6] py-2 px-4 text-base grid">
              <InputField
                type="number"
                placeHolder=""
