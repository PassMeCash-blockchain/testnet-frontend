...
const ServiecesSection = ({
  ...
  return (
    <di className="grid place-items-center shadow-[-24px_0px_32px_-8px_rgba(0,0,0,0.05),_0px_24px_32px_-8px_rgba(0,_0,_0,_0.05)] rounded-lg py-10 container mx-auto md:grid-cols-2 md:py-0 md:rounded-none md:shadow-none md:max-w-none">
      {/* Image */}
      <div
        className={clsx(
