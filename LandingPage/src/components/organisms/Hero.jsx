            ...
            <div className="grid grid-cols-[1fr_50vw] container mx-auto">
                <div className="pt-10">
                    ...
                    <h1 className="font-bold text-5xl mt-6">
                        {res.allHeroData.t1} <span className="text-primaryColor">{res.allHeroData.t2}</span> {res.allHeroData.t3 + "   "}<span>{" "}</span>
                        <span className="text-primaryColor">{res.allHeroData.t4}</span>{res.allHeroData.t5}<span className="text-primaryColor">{res.allHeroData.t6}</span>.
                    </h1>
